...
from home.models import Person, ImageModel, MyImage,Image, Statistics
from home.serializers import PeopleSerializer, LoginSerializer, RegisterSerializer, ImageModelSerializer,ImageSerializer,MyImageSerializer,StatSerializer
